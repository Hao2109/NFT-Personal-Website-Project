    ...
    <>
      <div className="container mx-auto text-white">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 py-8">
          <div className=" text-center rounded-2xl border w-full p-1 md:p-4 flex flex-col items-center gap-4 cursor-pointer hover:scale-105 transition-all">
            <img src="/img/create1.png" alt="" className="w-40 h-40" />
